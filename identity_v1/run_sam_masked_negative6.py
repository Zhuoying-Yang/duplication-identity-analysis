...
MANIFEST = BASE / "NEGATIVE6_FROZEN.csv"

SIGLIP_BASE = (
    BASE / "siglip_source_match_negative6"
)

CANDIDATE_CSV = (
    SIGLIP_BASE / "SIGLIP_NEGATIVE6_CANDIDATES.csv"
)
